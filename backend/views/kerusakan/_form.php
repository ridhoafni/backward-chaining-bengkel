	...
	<div class="col-md-12">
		...
		<?php $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data','class'=>'form-horizontal panel panel-default']]) ?>
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label">Keterangan Kerusakan</label>
					<div class="col-sm-6">
						<?= $form->field($model, 'ket_kerusakan')->textInput(['maxlength' => true,'placeholder'=>'ket Kerusakan','class'=>'form-control'])->label(false) ?>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">Solusi</label>
					<div class="col-sm-6">
						<?= $form->field($model, 'solusi')->textArea(['maxlength' => true,'placeholder'=>'solusi','class'=>'form-control'])->label(false) ?>
					</div>
				</div>
				</div>
